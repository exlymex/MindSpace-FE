            ...
            <View style={s.detailsCard}>
              <View style={s.detailRow}>
                <View style={s.detailIcon}>
                  <IconButton icon="calendar" size={20} iconColor={theme.colors.ezPrimary} style={{ margin: 0 }} />
                </View>
              ...
              <View style={s.detailRow}>
                <View style={s.detailIcon}>
                  <IconButton icon="clock-outline" size={20} iconColor={theme.colors.ezPrimary} style={{ margin: 0 }} />
                </View>
                <CustomText variant="ezSubtitleRegular" style={s.detailLabel}>
                  Час:
                </CustomText>
              ...
              <View style={s.detailRow}>
                <View style={s.detailIcon}>
                  <IconButton icon="cash" size={20} iconColor={theme.colors.ezPrimary} style={{ margin: 0 }} />
                </View>
                <CustomText variant="ezSubtitleRegular" style={s.detailLabel}>
                  Вартість:
                </CustomText>
              ...
              <View style={s.detailRow}>
                <View style={s.detailIcon}>
                  <IconButton icon="video" size={20} iconColor={theme.colors.ezPrimary} style={{ margin: 0 }} />
                </View>
                <CustomText variant="ezSubtitleRegular" style={s.detailLabel}>
                  Формат:
                </CustomText>
